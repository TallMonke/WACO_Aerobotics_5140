...
public class Constants {
    ...
    static public final Pose2d red_firstLinePos = new Pose2d(-32, 30, Math.toRadians(-90));
    static public final Pose2d red_secondLinePos = new Pose2d(8, 30, Math.toRadians(-90));
    static public final Pose2d red_thirdLinePos = new Pose2d(-11, 28, Math.toRadians(-90));
    static public final Pose2d blue_firstLinePos = new Pose2d(32, -30, Math.toRadians(-90));
    static public final Pose2d blue_secondLinePos = new Pose2d(8, -30, Math.toRadians(-90));
