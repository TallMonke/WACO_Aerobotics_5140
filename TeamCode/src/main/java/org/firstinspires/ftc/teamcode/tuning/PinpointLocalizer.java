...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2199.0003475510835; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2844.3457108158336; // x position of the perpendicular encoder (in tick units)
    }
